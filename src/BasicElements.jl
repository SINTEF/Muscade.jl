...
@espy function lagrangian(o::ElementCost, Λ,X,U,A,t,χ,SP,dbg)
    req        = merge(o.req)
    L,χ,FB,☼eleres = getlagrangian(implemented(o.eleobj)...,o.eleobj,Λ,X,U,A,t,χ,identity,SP,(dbg...,via=ElementCost),req.eleres)
...
@espy function lagrangian(o::ElementConstraint{Teleobj,λinod,λfield,Nu}, Λ,X,U,A,t,χ,SP,dbg) where{Teleobj,λinod,λfield,Nu} 
    ...
    ☼λ         = ∂0(U)[Nu+1]
    L,χn,FB,☼eleres = getlagrangian(implemented(o.eleobj)...,o.eleobj,Λ,X,u,A,t,χ,identity,SP,(dbg...,via=ElementConstraint),req.eleres)
...
@espy function lagrangian(o::Monitor{Teleobj}, Λ,X,U,A,t,χ,SP,dbg)  where{Teleobj}
    L,χn,FB = getlagrangian(implemented(o.eleobj)...,o.eleobj,Λ,X,U,A,t,χ,SP,(dbg...,via=Monitor))
    if o.trigger(dbg)
        @show dbg
        @show SP
        @show VALUE(χ)
