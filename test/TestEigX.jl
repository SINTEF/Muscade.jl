...
@testset "EigX" begin
    @test eiginc.p[1:nmod]    ≈ [0.10517722364770647 - 4.762644452370236e-17im, 0.1948227763522931 + 9.598886497048079e-17im, 0.14999999999999958 - 0.3995436605528897im, 0.1499999999999998 + 0.39954366055289037im, 0.14999999999999933 + 0.6862471569706331im]
    @test state.X[1][1:2:end] ≈ [-0.295349913218206, -0.8641449877271711, -1.3688503816966837, -1.7720344049295693, -2.043794742866822, -2.163976174464458]
    @test state.X[2][1:2:end] ≈ [-0.058639602696423314, -0.17156977701560847, -0.27177540585304977, -0.35182469612812317, -0.40578075818226267, -0.4296419177254722]
    @test state.X[3][1:2:end] ≈ [-0.011539889743192326, -0.033763808398807195, -0.05348361984462822, -0.06923679587785343, -0.07985499549808367, -0.08455071541451746]
    end
