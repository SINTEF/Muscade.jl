...
@testset "Adiff" begin
    @testset "Adiff construct and promote" begin
        ...
        @test h          === x
        @test Muscade.variate²{1,2}(7.,2) ===  ∂ℝ{2, 2, ∂ℝ{1, 2, Float64}}(∂ℝ{1, 2, Float64}(7.0, [0.0, 1.0]), ∂ℝ{1, 2, Float64}[∂ℝ{1, 2, Float64}(0.0, [0.0, 0.0]), ∂ℝ{1, 2, Float64}(1.0, [0.0, 0.0])])
        @test Muscade.variate²{1,2}(7.,2,1.5) ===  ∂ℝ{2, 2, ∂ℝ{1, 2, Float64}}(∂ℝ{1, 2, Float64}(7.0, [0.0, 1.5]), ∂ℝ{1, 2, Float64}[∂ℝ{1, 2, Float64}(0.0, [0.0, 0.0]), ∂ℝ{1, 2, Float64}(1.5, [0.0, 0.0])])
    end
