...
function MAC(v1::AbstractVector, v2::AbstractVector)
    return  (v1' * v2)^2 ./ (norm(v1)^2 * norm(v2)^2)
end
...
@testset "eigenmodes SDP" begin
    ...
    @test MAC(v[1][1:200:end],      [  0.00014028558300245532,    0.026364134154732224,    0.042537225116976426,    0.04249391630968802,    0.02625071828168894])       ≈ 1.000
    @test MAC(v[2][1:200:end],      [  0.00028056978420787495,    0.042580114937435326,    0.02613704384203099,   -0.026364134154727957,   -0.04249391630968351])       ≈ 1.000
end
...
@testset "eigenmodes Hermitian" begin
    ...
    @test MAC(v[1][1:200:end],      [  0.0002811008347510544,    0.026372151256201664,    0.04254237814552391,    0.042489472779309846,    0.02624087646034281])        ≈ 1.000
    @test MAC(v[2][1:200:end],      [ -0.0005640094745986227,    -0.04274190474190939,    -0.02628003327036983,     0.026212397939501447,     0.042340762998788375 ])   ≈ 1.000
end
...
@testset "eigenmodes Unsymmetric" begin
    ...
    @test MAC(real.(v[1][1:200:end]),[ -0.0002805684107607904,    -0.026364133746437556,    -0.042537225451125094,    -0.04249391664172418,    -0.026250717868500813 ]) ≈ 1.000
    @test MAC(real.(v[2][1:200:end]),[ -0.0005611175282438147,    -0.042580114600632754,    -0.026137046653016693,     0.026364136984402934,     0.042493915923130676 ])≈ 1.000
end
