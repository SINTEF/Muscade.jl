...
# (∂ℝ{1, 3, Float64}[∂ℝ{1, 3, Float64}(1.0, [0.0, 0.0, 1.0]), ∂ℝ{1, 3, Float64}(0.0, [0.0, 1.0, 0.0])], ∂ℝ{1, 3, Float64}(2.0, [1.0, 0.0, 0.0]), ∂ℝ{1, 3, Float64}[∂ℝ{1, 3, Float64}(3.0, [0.0, 0.0, 0.0]), ∂ℝ{1, 3, Float64}(4.0, [0.0, 0.0, 0.0])], 5.0) 
# (∂ℝ{1, 3, Float64}[∂ℝ{1, 3, Float64}(1.0, [0.0, 0.0, 1.0]), ∂ℝ{1, 3, Float64}(0.0, [0.0, 1.0, 0.0])], ∂ℝ{1, 3, Float64}(2.0, [1.0, 0.0, 0.0]), [3.0, 4.0], 5.0)
