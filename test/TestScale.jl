...
stateXUA1       = solve(StaticXUAstepwise;initialstate=stateX1,verbose=false)
...
stateXUA2       = solve(StaticXUAstepwise;initialstate=stateX2,verbose=false)

step = 1
@testset "ScaleStaticX" begin
    @test  stateX1[step].X[1] ≈ stateX2[step].X[1]
end
@testset "ScaleStaticXUAstepwise" begin
