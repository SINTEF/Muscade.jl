...
@once fu(u,t)   = (u/.1)^2/2
@once l1(tx1,t) = ((tx1-0.1*sin(t))/.01)^2/2
@once l2(tx1,t) = ((tx1-0.1*cos(t))/.01)^2/2
...
@testset "output" begin
    @test dof[1,1:100:end]      == [ -0.000852222487662155, 0.09549942165460334, -0.050089605685852384,   -0.06878034794799491, 0.08677879820843741,    0.022490322826934462,   -0.09877571024378277,    0.030199161274387057,    0.0826667070899406,   -0.07429569207304232,   -0.04303548928732618]
