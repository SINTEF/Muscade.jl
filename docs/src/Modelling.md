...
[`getresult`](@ref) (used in combination with [`@request`](@ref)) allows to obtain element-results which have been marked as requestable inside the function [`Muscade.lagrangian`](@ref) or [`Muscade.residual`](@ref) of an element. These element-results are not stored in the `State`: [`getresult`](@ref) will call a modified version of [`Muscade.lagrangian`](@ref) or [`Muscade.residual`](@ref) to obtain the [`@request`](@ref)ed results.
