...
@functor with() f2(x,t)   = 1x^2
@functor with() f3(a)     = 0.11a^2
...
state           = solve(StaticXUA;initialstate=stateX,verbose=false)
...
#    local state  = solve(StaticXUA;initialstate=stateX,verbose=false);
end
