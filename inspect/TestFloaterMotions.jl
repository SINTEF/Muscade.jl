...
e1        =  addelement!(model,FloaterOnCalmWater,[n1]; K,Cₒ,M)
e2        = [addelement!(model,SingleDofCost     ,[n1]; class=:U,field=f           ,    cost=(u,t)->u^2) for f∈floatermotion]
e3        = [addelement!(model,SingleDecayAcost  ,[n1];          field=Symbol(:C,i),fac,cost=(a  )->a^2) for i∈floatermotion] 
